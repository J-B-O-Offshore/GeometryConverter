...
Sub load_Bladed_dropdown()
    ...
    RunPythonWrapper "export", "fill_bladed_py_dropdown"
End Sub

Sub select_soil_stiff_global()
    OpenFileDialog "path_soil_matrix", "select soil csv file", "csv files", "*.csv"
End Sub

Sub select_py_curve_global()
    OpenFileDialog "path_soil_py", "select soil csv file", "csv files", "*.csv"
End Sub
...
Sub load_Bladed_soil_stiffness_mat()
    ...
    ClearTableContents "ExportStructure", "Bladed_soil_stiffness_mat"
     ...
     RunPythonWrapper "export", "load_Bladed_soil_file_mat"
End Sub
